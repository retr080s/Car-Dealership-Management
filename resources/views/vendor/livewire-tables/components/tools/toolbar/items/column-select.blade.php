...
<div class="@if ($component->getColumnSelectIsHiddenOnMobile()) hidden sm:block @elseif ($component->getColumnSelectIsHiddenOnTablet()) hidden md:block @endif mb-4 w-full md:w-auto md:mb-0 md:ml-2">
    ...
    >
        <div>
            <span class="rounded-md shadow-sm">
                <button
                    ...
                    type="button"
                    class="inline-flex justify-center px-4 py-2 w-full text-sm font-medium text-gray-700 bg-white rounded-md border border-gray-300 shadow-sm hover:bg-gray-50 focus:border-teal-300 focus:ring focus:ring-teal-700 focus:ring-opacity-50 dark:bg-teal-700/50 dark:text-white dark:border-teal-800 dark:hover:bg-teal-900"
                    aria-haspopup="true"
        ...
        >
            <div class="bg-white rounded-md shadow-xs dark:bg-teal-900 dark:text-white">
                ...
                >
                    <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                        ...
                        >
                            <input
                                class="text-teal-600 transition duration-150 ease-in-out border-gray-300 rounded shadow-sm focus:border-indigo-300 focus:ring focus:ring-teal-600 focus:ring-opacity-50 dark:bg-teal-900 dark:text-white dark:border-gray-600 dark:hover:bg-teal-900 dark:focus:bg-teal-600 disabled:opacity-50 disabled:cursor-wait"
                                wire:loading.attr="disabled" 
                                type="checkbox"
                    ...
                    @foreach ($component->getColumnsForColumnSelect() as $columnSlug => $columnTitle)
                        ...
                        >
                            ...
                            >
                                <input
                                    class="text-teal-900 rounded border-gray-300 shadow-sm transition duration-150 ease-in-out focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-teal-900 dark:text-white dark:border-teal-200 dark:hover:bg-teal-600 dark:focus:bg-teal-700 disabled:opacity-50 disabled:cursor-wait"
